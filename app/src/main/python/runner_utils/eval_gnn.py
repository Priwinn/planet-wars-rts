...
def _fast_agent_eval(test_agent, n_games, game_params, baseline_agents): 
    ...
    win_rate = fast_agent_eval(test_agent, n_games=10, game_params=GameParams(num_planets=20),baseline_agents=[GreedyHeuristicAgent(), CarefulRandomAgent()])
...
if __name__ == "__main__":
    ...
    # _fast_agent_eval(test_agent, n_games=10, game_params=GameParams(num_planets=20), baseline_agents=[GreedyHeuristicAgent(), CarefulRandomAgent()])
