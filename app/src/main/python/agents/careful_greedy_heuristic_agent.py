...
class CarefulGreedyHeuristicAgent(PlanetWarsPlayer):
    def get_action(self, game_state: GameState) -> Action:
        ...
        if source.n_ships/2 <= estimated_defense:
            return Action.do_nothing()
    ...
    def get_agent_type(self) -> str:
        return "Better Greedy Heuristic Agent in Python"


# Example usage
if __name__ == "__main__":
    agent = BetterGreedyHeuristicAgent()
